...
echo "Total Score : $total <br>";
    if ($total >= 80) echo "<br><img src= image/A.jpg  width = 100>";
        elseif ($total >= 70) echo "<img src= image/B.jpg  width = '100'><br>";
        elseif ($total >= 60) echo "<img src= image/C.jpg  width = '100'><br>";
        elseif ($total >= 50) echo "<img src= image/D.jpg  width = '100'><br>";
        else echo "<img src= image/A.jpg  width = '100'><br>";
echo "<br>";
