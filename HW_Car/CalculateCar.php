    ...
    <?php if (isset($_GET['submit'])) : ?>
        ...
        <div class="inline1" id="divleft">
            <?php if ($cname == "Accord") : ?>
                <?php $price = 1799000;
                $year = 2; ?>
                <img src="img/logo-accord.png" class="logo"><br>
                <img src="img/Accord.png" class="carpic">
            <?php elseif ($cname == "Civic") : ?>
                <?php $price = 1145000;
                $year = 2; ?>
                <img src="img/logo-civic.png" class="logo"><br>
                <img src="img/Civic.png" class="carpic">
            <?php elseif ($cname == "Jazz") : ?>
                <?php $price = 754000;
                $year = 4; ?>
                <img src="img/logo-jazz.png" class="logo"><br>
                <img src="img/Jazz.png" class="carpic">
            <?php elseif ($cname == "City") : ?>
                <?php $price = 749000;
                $year = 4; ?>
                <img src="img/logo-city.png" class="logo"><br>
                <img src="img/City.png" class="carpic">
            <?php endif ?>
        </div>
